...
function loadGroupFriendsList() {
  fetch('/api/friends')
    ...
    .then(friends => {
      ...
      container.innerHTML = friends.map(f => `
        <div class="friend-item" style="padding:8px 12px;background:rgba(255,255,255,0.02);border-radius:10px;display:flex;align-items:center;gap:12px;">
          <div class="friend-avatar" style="width:36px;height:36px;border-radius:50%;background:rgba(91,108,255,0.15);display:flex;align-items:center;justify-content:center;font-size:18px;overflow:hidden;">
